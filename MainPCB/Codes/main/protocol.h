...
#define ERROR_HEATER_NO_FUEL    0x01
#define ERROR_MPPT_COMM         0x02
#define ERROR_SENSOR_COMM       0x03
#define ERROR_SLAVE_COMM        0x04
#define ERROR_LED_STRIP         0x05
#define ERROR_FAN_CONTROL       0x06
