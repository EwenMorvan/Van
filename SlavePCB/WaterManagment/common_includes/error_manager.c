...
static slave_error_state_t system_error_state = {0};
...
const char* get_error_string(slave_pcb_err_t error) {
    switch (error) {
        ...
        case SLAVE_PCB_ERR_INIT_FAIL: return "Initialization failed";
        case SLAVE_PCB_ERR_MEMORY: return "Memory allocation failed";
        
        // Communication errors
        case SLAVE_PCB_ERR_COMM_FAIL: return "Communication failure";
        case SLAVE_PCB_ERR_I2C_FAIL: return "I2C communication failed";
        case SLAVE_PCB_ERR_SPI_FAIL: return "SPI communication failed";
        case SLAVE_PCB_ERR_TIMEOUT: return "Operation timeout";
        
        // Device errors
        case SLAVE_PCB_ERR_DEVICE_NOT_FOUND: return "Device not found";
        case SLAVE_PCB_ERR_DEVICE_BUSY: return "Device busy";
        case SLAVE_PCB_ERR_DEVICE_FAULT: return "Device fault detected";
        
        // State/Case errors
        case SLAVE_PCB_ERR_STATE_INVALID: return "Invalid state";
        case SLAVE_PCB_ERR_INCOMPATIBLE_CASE: return "Incompatible case";
        case SLAVE_PCB_ERR_CASE_TRANSITION: return "Case transition failed";
        
        // Safety errors
        case SLAVE_PCB_ERR_SAFETY_LIMIT: return "Safety limit exceeded";
        case SLAVE_PCB_ERR_EMERGENCY_STOP: return "Emergency stop triggered";
        case SLAVE_PCB_ERR_OVERCURRENT: return "Overcurrent detected";
        case SLAVE_PCB_ERR_SENSOR_RANGE: return "Sensor value out of range";
...
error_severity_t error_get_severity(slave_pcb_err_t error) {
    if (error == SLAVE_PCB_OK) return ERR_SEVERITY_INFO;
...
error_category_t error_get_category(slave_pcb_err_t error) {
    if (error == SLAVE_PCB_OK) return ERR_CAT_NONE;
...
slave_error_state_t* error_get_system_state(void) {
